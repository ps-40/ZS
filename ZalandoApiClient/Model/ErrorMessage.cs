...
namespace ZalandoApiClient.Model
{
    ...
    public partial class ErrorMessage :  IEquatable<ErrorMessage>
    {
        ...
        public ErrorMessage(int? Status = null, string Message = null, List<ErrorDetail> Errors = null)
        {
            // to ensure "Status" is required (not null)
            if (Status == null)
            {
                throw new InvalidDataException("Status is a required property for ErrorMessage and cannot be null");
            }
            else
            {
                this.Status = Status;

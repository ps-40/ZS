...
namespace ZalandoApiClient.Test
{
    ...
    public class BrandsApiTests
    {
        ...
        public void BrandsGetTest()
        {
            ...
            //var response = instance.BrandsGet(key, name, brandFamilyName, brandFamilyKey, page, pageSize, acceptLanguage, fields);
            //Assert.IsInstanceOf<Brands> (response, "response is Brands");
        }
        ...
        /// </summary>
        [Test]
        public void BrandsKeyGetTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string key = null;
            //string acceptLanguage = null;
            //List<string> fields = null;
            //var response = instance.BrandsKeyGet(key, acceptLanguage, fields);
